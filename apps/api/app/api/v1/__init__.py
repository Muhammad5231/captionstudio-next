...
from apps.api.app.api.v1.admin_auth import router as admin_auth_router
from apps.api.app.api.v1.admin import router as admin_router
from apps.api.app.api.v1.admin_styles import router as admin_styles_router
...
from apps.api.app.api.v1.styles import router as styles_router
...
api_v1_router.include_router(admin_auth_router, tags=["Admin Authentication"])
api_v1_router.include_router(admin_router, tags=["Admin Panel"])
api_v1_router.include_router(admin_styles_router, tags=["Admin Style Management"])
...
api_v1_router.include_router(styles_router, tags=["Styles"])
